---
title: 'Introduction to DeepDive Platform'
description: 'AI-powered social intelligence for teams'
---

**DeepDive** is an AI-powered social intelligence platform that helps teams collect, analyze, and act on large-scale online conversation data. It processes unstructured data from social media, communities, and review platforms, turning it into structured insights through NLP, signal analysis, and automated workflows.
